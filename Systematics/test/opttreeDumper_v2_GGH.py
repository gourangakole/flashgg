...
process.p = cms.Path(process.dataRequirements*process.flashggMets*process.flashggTagSequence*process.flashggSystTagMerger*process.flashggTagCandidateProducer*process.tagCandidateDumper)
