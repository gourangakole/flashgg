...
temp_dipho_variables=["dipho_sumpt      := diPhoton.sumPt",
                      ...
                      "genmatch1  := diPhoton.leadingPhoton.genMatchType()",
                      "genmatch2  := diPhoton.subLeadingPhoton.genMatchType()"
                      ]
...
for tag in tagList: 
  ...
  for systlabel in systlabels:
      ...
      print 'debug: process.tagsDumper', process.tagsDumper
...
# process.flashggUpdatedIdMVADiPhotons.src = cms.InputTag("flashggPreselectedDiPhotons")
