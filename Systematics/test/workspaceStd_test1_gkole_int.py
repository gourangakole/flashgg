...
process.tagsDumper.dumpTrees = True # gkole changed from Flase to True
process.tagsDumper.dumpWorkspace = False # gkole changed from "True" to "False"
process.tagsDumper.dumpHistos = True # gkole changed from False to True
process.tagsDumper.quietRooFit = False # gkole changed from "True" to "False"
