...
namespace flashgg {
    ...
    private:
        ...
        //EDGetTokenT<View<pat::MET> > METToken_; // gkole1
    ...
    WHLeptonicTagProducer::WHLeptonicTagProducer( const ParameterSet &iConfig ) :
        ...
        //METToken_( consumes<View<pat::MET> >( iConfig.getParameter<InputTag> ( "METTag" ) ) ), //gkole1
    ...
    void WHLeptonicTagProducer::produce( Event &evt, const EventSetup & )
    {
        ...
        //Handle<View<pat::MET> > METs; // temporary gkole
        ...
        for( unsigned int diphoIndex = 0; diphoIndex < diPhotons->size(); diphoIndex++ ) {
            ...
            //edm::Ptr<pat::MET>  tagMETs; //gkole1
            ...
            //Ptr<pat::MET> theMET = METs->ptrAt( 0 ); //gkole1
