...
EfficiencyBins = cms.PSet(
    ...
    probe_Pho_r9 = cms.vdouble(0. ,.85 ,1.), #EB
    probe_sc_abseta = cms.vdouble(0.0, 1.479), #EB
    #probe_Pho_r9 = cms.vdouble(0. ,.90 ,1.), #EE
    #probe_sc_abseta = cms.vdouble(1.479, 2.5), #EE
    )
...
DataBinningSpecification = cms.PSet(
    ...
    BinToPDFmap = cms.vstring(
        ...
        "*r9_bin0*abseta_bin0*","passingPresel_0p0To0p85_0p0To1p479", #EB
        "*r9_bin1*abseta_bin0*","passingPresel_0p85To1p0_0p0To1p479", #EB
        #"*r9_bin0*abseta_bin0*","passingPresel_0p0To0p9_1p479To2p5", #EE
        #"*r9_bin1*abseta_bin0*","passingPresel_0p9To1p0_1p479To2p5", #EE
        )
    )
