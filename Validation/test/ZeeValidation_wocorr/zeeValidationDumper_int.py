...
#process.p = cms.Path(process.flashggUpdatedIdMVADiPhotons*process.flashggDiPhotonSystematics)
...
#process.p = cms.Path(process.flashggDiPhotonSystematics*process.dataRequirements*process.diphotonDumper)
