...
#process.source = cms.Source ("PoolSource",fileNames = cms.untracked.vstring("root://eoscms.cern.ch//eos/cms/store/group/phys_higgs/cmshgg/ferriff/flashgg/RunIISpring16DR80X-2_1_0-25ns_ICHEP16/2_1_0/GluGluHToGG_M125_13TeV_amcatnloFXFX_pythia8/RunIISpring16DR80X-2_1_0-25ns_ICHEP16-2_1_0-v0-RunIISpring16MiniAODv1-PUSpring16RAWAODSIM_plus5percentMaterial_80X_mcRun2_asymptotic_2016_v3-v1/160618_074908/0000/myMicroAODOutputFile_1.root",



#process.source = cms.Source ("PoolSource",fileNames = cms.untracked.vstring("root://eoscms//eos/cms/store/group/phys_higgs/cmshgg/ferriff/flashgg/RunIISpring16DR80X-2_1_0-25ns_ICHEP16/2_1_0/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/RunIISpring16DR80X-2_1_0-25ns_ICHEP16-2_1_0-v0-RunIISpring16MiniAODv2-PUSpring16_plus5percentMaterial_80X_mcRun2_asymptotic_2016_miniAODv2_v0-v1/160618_073657/0000/myMicroAODOutputFile_3.root",))
...
#START check
#Check with zeevalidation dumper 
...
#process.tagCandidateDumper.src = cms.InputTag("flashggUpdatedIdMVADiPhotons")
...
"""
(abs(diPhoton.leadingPhoton.superCluster.eta) < 2.5 && abs(diPhoton.subLeadingPhoton.superCluster.eta) < 2.5 && diPhoton.leadingPhoton.hasPixelSeed()==1) &&
                                        (diPhoton.leadingPhoton.pt > 33) &&
                                        (diPhoton.leadingPhoton.hadronicOverEm < 0.1) &&
                                        ((diPhoton.leadingPhoton.full5x5_r9 > 0.53 && diPhoton.leadingPhoton.isEB) || (diPhoton.leadingPhoton.full5x5_r9 > 0.83 && diPhoton.leadingPhoton.isEE)) &&
                                        ((diPhoton.subLeadingPhoton.full5x5_r9 > 0.53 && diPhoton.subLeadingPhoton.isEB) || (diPhoton.subLeadingPhoton.full5x5_r9 > 0.83 && diPhoton.subLeadingPhoton.isEE)) &&
                                        ((diPhoton.leadingPhoton.isEB &&
                                        (diPhoton.leadingPhoton.full5x5_r9>0.85 ||
                                        (diPhoton.leadingPhoton.full5x5_sigmaIetaIeta < 0.015 && diPhoton.leadingPhoton.pfPhoIso03 < 4.0 && diPhoton.leadingPhoton.trkSumPtHollowConeDR03 < 6.0 ))) ||
                                        (diPhoton.leadingPhoton.isEE &&
                                        (diPhoton.leadingPhoton.full5x5_r9>0.9 ||
                                        (diPhoton.leadingPhoton.full5x5_sigmaIetaIeta < 0.035 && diPhoton.leadingPhoton.pfPhoIso03 < 4.0 && diPhoton.leadingPhoton.trkSumPtHollowConeDR03 < 6.0 )))) &&
                                        (diPhoton.leadingPhoton.pt > 14 && diPhoton.leadingPhoton.hadTowOverEm()<0.15 &&
                                        (diPhoton.leadingPhoton.r9()>0.83 || diPhoton.leadingPhoton.chargedHadronIso()<20 || diPhoton.leadingPhoton.chargedHadronIso()<0.3*diPhoton.leadingPhoton.pt())) &&

                         (abs(diPhoton.leadingPhoton.superCluster.eta) < 2.5 && abs(diPhoton.subLeadingPhoton.superCluster.eta) < 2.5 && diPhoton.subLeadingPhoton.hasPixelSeed()==1) &&
                                          (diPhoton.subLeadingPhoton.pt > 25) && 
                                          (diPhoton.subLeadingPhoton.hadronicOverEm < 0.1) &&
                                          ((diPhoton.leadingPhoton.full5x5_r9 > 0.53 && diPhoton.leadingPhoton.isEB) || (diPhoton.leadingPhoton.full5x5_r9 > 0.83 && diPhoton.leadingPhoton.isEE)) &&
                                          ((diPhoton.subLeadingPhoton.full5x5_r9 > 0.53 && diPhoton.subLeadingPhoton.isEB) || (diPhoton.subLeadingPhoton.full5x5_r9 > 0.83 && diPhoton.subLeadingPhoton.isEE)) &&
                                          (( diPhoton.subLeadingPhoton.isEB &&
                                          (diPhoton.subLeadingPhoton.full5x5_r9>0.85 ||
                                          (diPhoton.subLeadingPhoton.full5x5_sigmaIetaIeta < 0.015 && diPhoton.subLeadingPhoton.pfPhoIso03 < 4.0 && diPhoton.subLeadingPhoton.trkSumPtHollowConeDR03 < 6.0 ))) ||
                                          (diPhoton.subLeadingPhoton.isEE &&
                                          (diPhoton.subLeadingPhoton.full5x5_r9>0.9 ||
                                          (diPhoton.subLeadingPhoton.full5x5_sigmaIetaIeta < 0.035 && diPhoton.subLeadingPhoton.pfPhoIso03 < 6.0 && diPhoton.subLeadingPhoton.trkSumPtHollowConeDR03 < 6.0 )))) &&
                                          (diPhoton.subLeadingPhoton.pt > 14 && diPhoton.subLeadingPhoton.hadTowOverEm()<0.15 &&
                                          (diPhoton.subLeadingPhoton.r9()>0.83 || diPhoton.subLeadingPhoton.chargedHadronIso()<20 || diPhoton.subLeadingPhoton.chargedHadronIso()<0.3*diPhoton.subLeadingPhoton.pt()))
...
process.p = cms.Path(process.flashggTagSequence*process.flashggSystTagMerger*process.flashggTagCandidateProducer*process.tagCandidateDumper) #original
#cms.Path()
...
#process.p = cms.Path(process.flashggUpdatedIdMVADiPhotons*process.flashggPreselectedDiPhotons*process.flashggTagSorter*process.tagCandidateDumper)
